...
{
    public partial class InitilAzure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifyOffset = table.Column<string>(nullable: true),
                    NotificationIsSent = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkRequestId = table.Column<Guid>(nullable: false),
                    SendToEmail = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_postnumre", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "relateCompanyAccountWithRoles",
                columns: table => new
                {
                    id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    companyAccount = table.Column<int>(nullable: false),
                    role = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_relateCompanyAccountWithRoles", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "relateCompanyAccountWithUsers",
                columns: table => new
                {
                    id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_relateCompanyAccountWithUsers", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_companyAccounts_companyAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_companyAccountId",
                table: "Companies",
