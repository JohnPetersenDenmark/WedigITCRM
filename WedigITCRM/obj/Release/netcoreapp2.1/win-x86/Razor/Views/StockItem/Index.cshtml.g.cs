#pragma checksum "C:\Users\John\source\repos\WedigITCRM\WedigITCRM\Views\StockItem\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "68584f69278065bfc3ea317711234cf2e4301ef3"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"68584f69278065bfc3ea317711234cf2e4301ef3", @"/Views/StockItem/Index.cshtml")]
...
<script>
    ...
    var initializingCate");
            WriteLiteral(@"gory2Field;
    var stockitemtable;
    ...
    $(document).ready(function () {
        ...
        //stockitemtable.columns.adjust();


        var newItem = document.createElement(""div"");       // Create a <div> node
        ");
            WriteLiteral(@"var textnode = document.createTextNode(""Varer"");  // Create a text node
        ...
        stockItemEditor.on('opened', function (e, json, data) {
            $(""#DTE_Field_inStockAgainDate"").datetimepicker({
              ...
              $(");
            WriteLiteral(@"""#DTE_Field_expirationdate"").datetimepicker({
                timepicker: false,
                datepicker: true,
                hours12: false,
                format: 'd-m-yy'
