...
function setZipDependency() {
    companyEditor.dependent('zip', function (val, data, callback) {
...
function setCountryCodeDependency() {
    companyEditor.dependent('countryCode', function (val, data, callback) {
        data = JSON.stringify(data.values);
        if (val == "DK") {
...
function initializeCompanyTableFooter() {
...
function initializeSearchCompanyTableFooter() {
    companytable.columns().every(function () {
        var that = this;
