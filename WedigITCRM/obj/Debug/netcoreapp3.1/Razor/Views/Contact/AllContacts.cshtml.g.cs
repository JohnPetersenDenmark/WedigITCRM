#pragma checksum "C:\Users\John\source\repos\WedigITCRM\WedigITCRM\Views\Contact\AllContacts.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "345e6954667a9f2906d05df29bd5ffbfe15f16a7"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Contact_AllContacts), @"mvc.1.0.view", @"/Views/Contact/AllContacts.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"345e6954667a9f2906d05df29bd5ffbfe15f16a7", @"/Views/Contact/AllContacts.cshtml")]
    ...
    public class Views_Contact_AllContacts : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral(@"<div style=""width:90%; margin:0px auto;"">
    <table id=""contacttable"" class=""table table-striped table-bordered dt-responsive nowrap"" style=""width:100%"" cellspacing=""0"">
        <thead>
            <tr>
                <th>Id</th>
                <th>Navn</th>
...
<script>
    ...
    var contacttable;
    var contactEditor; // use a global for the submit and return data rendering in the examples
    var suggestData;    
    var optionsA = [];
    ...
    $(document).ready(function () {
        ...
        contacttable = initializecontactTable();

        initializecontactTableFooter();
        initializeSearchcontactTableFooter();

        setPresubmitEventHandlerOnContactEditor();

        setPostSubmitEventHandlerOncontactEditor();

        setContactZipDependency();
        setContactCountryCodeDependency();
        ...
        var getThediv = $('#contacttable_length').parent();
        var htmlStr = '<div class=""col-sm-1""><select cla");
            WriteLiteral(@"ss=""custom-select custom-select-sm form-control form-control-sm"" id=""customershowselection""><option value=""1"">Alle</option><option value=""2"">Private</option><option value=""3"">CVR-registrerede</option> </select></div>';
        ...
        var textnode = document.createTextNode(""Kontakter"");  // Create a text node
        newItem.appendChild(textnode);
        newItem.classList.add(""tableheadline"");
        newItem.classList.add(""col-sm-2"");


        var Mydiv = document.getElementById('contacttable_wrapper');
        ...
        contacttable.on('xhr.dt', function (e, settings, json, xhr) {
            if (xhr.status != 200) {
