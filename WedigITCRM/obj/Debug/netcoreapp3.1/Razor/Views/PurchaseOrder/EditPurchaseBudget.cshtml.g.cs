#pragma checksum "C:\Users\John\source\repos\WedigITCRM\WedigITCRM\Views\PurchaseOrder\EditPurchaseBudget.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "faad6bff05f33b578d28bd8c4eb5c01b5e5756d6"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"faad6bff05f33b578d28bd8c4eb5c01b5e5756d6", @"/Views/PurchaseOrder/EditPurchaseBudget.cshtml")]
    ...
    public class Views_PurchaseOrder_EditPurchaseBudget : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<PurchaseBudgetEditViewModel>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("input", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "faad6bff05f33b578d28bd8c4eb5c01b5e5756d65210", async() => {
            }
            );
    ...
    <script>
        ...
        function drop(ev) {
            ...
            if (dataArray[1] == ""1""");
                ...
                var periodLineId = ev.target.getAttribute");
                WriteLiteral(@"(""id"");

                createBudgetLine(stockItemId, periodLineId);
            }
            ...
            if (dataArray[1] == ""0"") {
                ...
                WriteLiteral(@"Divs.length; i++) {
                    ...
                    newBudgetLineDiv.innerHTML = ' <div class=""col-3""><label>Antal</label><input type=""text"" name=""Quantity"" class=""periodline-input-field"" value=""' + sourceQuantity + '"" /></div>' + newBudgetLineDiv.inn");
                WriteLiteral(@"erHTML;
        ...
        function createBudgetLine(stockItemId, periodLineId) {
            ...
            $.ajax({
                ...
                data: {
                 ...
                 ");
                WriteLiteral(@"   periodLineId: periodLineId,
                ...
                success: function (result) {
                    ...
                    sourceDiv.innerHTML = ' <div class=""col-3""><label>Antal</label><input type=""text"" name=""Quantity"" class=""periodline-input-field"" /></div>' + sourceDiv.innerH");
                WriteLiteral(@"TML;
        ...
        function updateBudgetLineQuantity(budgetLineId, Quantity) {
            ...
            $.ajax({
                type: ""POST"",
     ");
                WriteLiteral(@"           url: ""/purchaseorder/updateBudgetLineQuantity"",
                data: {
                    id: budgetLineId,
