#pragma checksum "C:\Users\John\source\repos\WedigITCRM\WedigITCRM\Views\Customer\AllCompaniesWithContactPersons.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "128211d43b2de027f6eeb646d5d2708b2841b513"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"128211d43b2de027f6eeb646d5d2708b2841b513", @"/Views/Customer/AllCompaniesWithContactPersons.cshtml")]
...
<script>
    ...
    ");
            WriteLiteral(@"    initializeTypeAheadInputCompanyCVR();
        ...
        var htmlStr = '<div class=""col-sm-1""><select class=""custom-select custom-select-sm form-control form-control-sm"" id=""customershowselection""><option value=""1"">Alle</opti");
            WriteLiteral(@"on><option value=""2"">Private</option><option value=""3"">CVR-registrerede</option> </select></div>';
       ...
       companyta");
            WriteLiteral(@"ble.on('xhr.dt', function (e, settings, json, xhr) {
            if (xhr.status != 200) {
