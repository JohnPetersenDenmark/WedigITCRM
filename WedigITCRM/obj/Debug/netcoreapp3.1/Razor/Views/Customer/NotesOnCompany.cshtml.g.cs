#pragma checksum "C:\Users\John\source\repos\WedigITCRM\WedigITCRM\Views\Customer\NotesOnCompany.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "04de33ae3841f7302a69741887bd9c5d566574c9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"04de33ae3841f7302a69741887bd9c5d566574c9", @"/Views/Customer/NotesOnCompany.cshtml")]
...
<script>
    ...
    $(document).ready(function () {
        ...
        var textnode ");
            WriteLiteral(@"= document.createTextNode(""Notater"");  // Create a text node
        ...
        var Myd");
            WriteLiteral(@"iv = document.getElementById('companytable_wrapper');
        var mychildren = Mydiv.getElementsByTagName('div');
        for (var i = 0; i < mychildren.length; ++i) {
            e = mychildren[i];
            var myclass = e.getAttribute(""class"");
        ...
        noteEditor.on('opened', function (e, json, data) {
           ...
           companytable.on('xhr.dt', function (e, settings, json, xhr) {
            if (xhr.status != 200) {
                 $.fn.dataTable.ext.errMode = 'throw';  // this disables the datatables ");
