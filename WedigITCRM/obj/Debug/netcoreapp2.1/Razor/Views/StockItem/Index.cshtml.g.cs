#pragma checksum "C:\Users\John\source\repos\WedigITCRM\WedigITCRM\Views\StockItem\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cfb45bca303d2e0c0949e9199fd153e28c67129d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cfb45bca303d2e0c0949e9199fd153e28c67129d", @"/Views/StockItem/Index.cshtml")]
...
<script>
    ...
    $(document).ready(function () {
        ...
        initializeTypeAheadInputStockItemVen");
            WriteLiteral(@"dorName();
        ...
        stockItemCategoryEditor.on('opened', function (e, json, data) {
            stockItemCategoryEditor.edit(stockitemtable.rows({ selecte");
            WriteLiteral(@"d: true }));
        ...
        stockitemtable.on('xhr.dt', function (e, settings, json, xhr) {
            if (xhr.status != 200) {
                $.fn.dataTable.ext.");
            WriteLiteral(@"errMode = 'throw';  // this disables the datatables error handling
