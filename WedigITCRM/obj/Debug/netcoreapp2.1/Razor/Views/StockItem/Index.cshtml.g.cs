#pragma checksum "C:\Users\John\source\repos\WedigITCRM\WedigITCRM\Views\StockItem\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a3ae11e2402cdda08513da804d9d61f259439359"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a3ae11e2402cdda08513da804d9d61f259439359", @"/Views/StockItem/Index.cshtml")]
...
<script>
    ...
    $(document).ready(function () {
        ...
        initializeTypeAheadInputStockItemVe");
            WriteLiteral(@"ndorName();
        ...
        stockItemCategoryEditor.on('opened', function (e, json, data) {
            ...
            if (selectedDatatableRowData.category1Id != null) {
                ...
                if (selectedDatatableRowData.category2Id != null) {
                    getCategory3ByCategory2(selectedDatatableRowD");
            WriteLiteral(@"ata.category2Id);
        ...
        stockItemCategoryEditor.on('open', function (e, mode, action) {
            var x = 1;
           // stockItemCategoryEditor.close();
        });
        ...
        stockitemtable.on('xhr.dt', function (e, settings, json, xhr) {
            if (xhr.status != 200) {
                ...
                locatio");
            WriteLiteral("n.href = \"/home/ShowErrorForJSON?errorinstance=\" + errorInstance;\r\n            }\r\n        })\r\n\r\n    });\r\n\r\n</script>\r\n");
            EndContext();
        }
