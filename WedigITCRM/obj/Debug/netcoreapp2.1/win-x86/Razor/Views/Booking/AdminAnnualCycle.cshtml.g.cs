#pragma checksum "C:\Users\John\source\repos\WedigITCRM\WedigITCRM\Views\Booking\AdminAnnualCycle.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4b230ac1d564cfeaefb2ad633267a106305d2dac"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4b230ac1d564cfeaefb2ad633267a106305d2dac", @"/Views/Booking/AdminAnnualCycle.cshtml")]
...
<div class=""formcontainer"">
    ...
    <div class=""form-group row"">
        ...
        <div class=""form-group col-sm-2"">
            ...
            <button type=""button"" class=""btn btn-primary"" OnClick=""toggleshowresour");
            WriteLiteral(@"cecalendar();"">Gem/Vis</button>
        </div>
    ...
    <div class=""form-group row"">
        ...
        <div class=""form-group col-sm-1"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7492019890ee48a8812cda90211b1888", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5a09ff8a0d994facb0c10171515d41a3", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1515429f41f34905bd40e021a182d0f0", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "51b92081f84f464ab4ed4e6d93dbc85b", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "036e80bdbb1e416e96317020bf3018f0", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "fe004118aa64498d8061cd6b05ceea0b", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ba5c6ea9c9c34e8e8bf4a9c58ae28929", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                EndContext();
                BeginContext(6291, 38, true);
                WriteLiteral("\r\n                                    ");
                EndContext();
                BeginContext(6329, 33, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "40aee5e626d94e05baedb0d6663b4ccf", async() => {
...
<script>
            ...
            WriteLiteral(@"      right: 'month,agendaWeek,agendaDay'
                ...
                events: function (start, end, timezone, callback) {
                    ...
                    $.ajax({
                        type: ""POST"",
                        url: ""/booking/GetR");
            WriteLiteral(@"esourceCalendarEvents"",
  ...
  ");
            WriteLiteral(@"                  $('#calendarEventResourceOwnerId').val(resourceId)
      ...
      ");
            WriteLiteral(@"                  $(""#caleventid"").val(eventObj._id);
            ...
            WriteLiteral(@"er"").val(startTime);
                    ...
                    if (eventObj.selectRepeat) {
                      ...
                      ");
            WriteLiteral(@"  $('#eventStartDate').attr(""disabled"", true);
                        $('#selectRepeatDiv').hide();
                    }
                    else {
                        $(""#caleventid"").val(eventObj._id);
                ...
                dayClick: function (start, jsEvent, view) {
                    ...
                    $('#selectRepeatDiv').hide();
             ");
            WriteLiteral(@"       $('#startdatetimediv').show();
                    $('#enddatetimediv').show();
...
");
            ...
            ");
            WriteLiteral(@"        $('#eventStartDate').val(eventObj.start.format(""DD-MM-YYYY""));
                    $(""#description"").val(eventObj.title);
                    $(""#calendarAction"").val(""Edit"");
                ...
                events: function (start, end, timezone, callback) {
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            $.each(result, function (i, data) {
                          ");
            WriteLiteral(@"      var momentStartDateDA = moment(data.startDateTime, 'DD-MM-YYYY kk:mm')
                                var momentStartDateCalStyleStr = momentStartDateDA.format(""YYYY-MM-DD kk:mm"");
                                var startDateTime = moment(momentStartDateCalStyleStr);
                ...
                $('#dialogSelectEvents').html(""""),
                    $.each(result, function (i, data) {
                        if (data.calEventId != $(""#caleventid"").val()) {
                            ...
                            htmlStr = htmlStr + '</div>';
                  ");
            WriteLiteral(@"          $('#dialogSelectEvents').append(htmlStr);
                        }
                    });
            },
                ...
                $.each(result, function (i, data) {
                    addResourceColorTagDiv(data),
                        $(""<option/>"", {
                            value: data.id,
           ");
            WriteLiteral(@"                 text: data.jobDescription
...
");
            WriteLiteral(@"        var JsonCalData = $(""#myForm"").serializeArray()
        ...
        $.ajax({
            ...
            WriteLiteral(@"e"") {
               ...
               // $('#annualcyclecalendar').fullCalendar();
                // $('#annualcyclecalendar').fullCalendar('removeE");
            WriteLiteral(@"vents');
    ...
    function postDeleteCalendarEntry() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result, function (i, data) {
                    ...
                    var momentEndDateDA = moment(data.endDateTime, 'DD-MM-YYYY kk:mm')
    ");
            WriteLiteral(@"                var momentEndDateCalStyleStr = momentEndDateDA.format(""YYYY-MM-DD kk:mm"");
                    var endDateTime = moment(momentEndDateCalStyleStr);
 ...
 ");
   ...
   ");
            WriteLiteral(@"                 var resourceId = $('#selectcalendarresource option:selected').val();
                    if (resourceId != ""0"") {
                        $.ajax({
                            type: ""POST"",
 ...
 ");
            WriteLiteral(@"                                   var momentEndDateCalStyleStr = momentEndDateDA.format(""YYYY-MM-DD kk:mm"");
                                    ...
                                    $('#resourcecalendar').fullCalendar('renderEvent', {
                                        ...
                                        repeatedId: data.repeatedId,
             ");
            WriteLiteral(@"                           title: data.description,
                                        start: startDateTime,
                                        end: endDateTime,
                                        allDay: AllDayFlag,
                                        selectRepeat: selectRepeatFlag,
                ...
                ""Fjern aftaler"": function () {
                    ...
                    if (resourceId != ""0"") {
                        $.ajax({
                            type: ""POST"",
                            ur");
            WriteLiteral(@"l: ""/booking/removeEventsForResource"",
                            data: 'id=' + resourceId,
                            contentType: ""application/x-www-form-urlencoded; charset=utf-8"",
                            dataType: ""json"",
                            success: function (result) {
            ...
            buttons: {
                ""Flyt"": function () {
                    ...
                    if (eventObj.allDay) {
                        ...
                        $(""#startdatetimepicker"").val(startTime);
               ");
            WriteLiteral(@"         $(""#selectallday"").prop(""checked"", true);
                    }
                    else {
                        var startTime = eventObj.start.format(""kk:mm"");
                        var endTime = eventObj.end.format(""kk:mm"");
